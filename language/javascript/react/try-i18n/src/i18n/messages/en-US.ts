...
export default {
  [LOCALES.ENGLISH]: {
    ...
    "contact.email": "Litavanchik@gmail.com",
    ...
    "studio.article2.p5": "But fortunately, The Lab masters both practices 🚀",
    ...
    "footer.light": "light",
    "footer.name": "Le Leb.",
    "footer.2023": "©2023 Le Leb - Ivanov Maksim - All rights reserved",
